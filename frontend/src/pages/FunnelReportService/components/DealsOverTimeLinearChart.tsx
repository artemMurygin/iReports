...
import {
  ...
  C_NEGATIVE,
  C_NEUTRAL,
} from '@/shared/constants/chartColors.ts';
        ...
        {activeTab === 'chart' && (
          <div className="flex flex-col gap-2">
            <ResponsiveContainer width="100%" height={320}>
              <LineChart data={weekData} margin={{ top: 8, right: 120, bottom: 4, left: 0 }}>
                ...
                <Tooltip
                  content={({ active, payload, label }) => {
                    ...
                    return (
                      ...
                      >
                        <p style={{ marginBottom: 6, fontWeight: 600, color: 'var(--popover-foreground)' }}>
                          {label}
                        </p>
                        {sorted.map(entry => {
