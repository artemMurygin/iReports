 ...
 * (блок "Магазин") все фиолетовые. Размер уменьшен вдвое против точки роли (`LedgerRoleGroup`'s
 * `DOT_CLASS`, `size-1.5`) — часть общего облегчения этого уровня, см. JSDoc компонента ниже. */
 ...
 *
 * Живёт только внутри развёрнутой группы роли (`LedgerRoleGroup`, тот же `bg-canvas`-фон "подложки",
 * что и у `RuleSourcesRail` ниже) — визуально ощутимо легче и КОМПАКТНЕЕ строки роли над ней (та же
