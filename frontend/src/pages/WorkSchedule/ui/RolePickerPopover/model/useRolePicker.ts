 ...
 * здесь гарантированно `'WORKING'` — `buildUpsertPayload` вызывается с ним и с `cell.hours` как
 * есть, без изменений (план: «передавая текущие статус/часы этого дня без изменений»). Тот же
 * билдер, что и у `useDayEditor` — не две copy-paste версии сборки тела `PUT /v1/work-schedule/entries`.
 */
