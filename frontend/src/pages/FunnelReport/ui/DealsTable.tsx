            ...
            <CardContent className="p-0">
                <div className="border border-gray-200 rounded-lg overflow-hidden mx-5">
                    ...
                    <div className="flex items-center h-11 bg-gray-50 border-b border-gray-200">
                        <div className="w-[130px] px-3 text-xs font-medium text-gray-500">
                            Создано
                        </div>
                        ...
                        <div className="w-[180px] px-3 text-xs font-medium text-gray-500">
                            Менеджер
                        </div>
                        <div className="w-[200px] px-3 text-xs font-medium text-gray-500">Этап</div>
                        <div className="w-[200px] px-3 text-xs font-medium text-gray-500">
                            Источник
                        </div>
                        <div className="w-[200px] px-3 text-xs font-medium text-gray-500">
                            Точка контакта
                        ...
                        <div className="w-[140px] px-3 text-xs font-medium text-gray-500 text-right">
                            Сумма
                        </div>
                    </div>
                    ...
                    {paginated.map((deal, idx) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className="w-[130px] px-3 text-sm text-gray-500"
                                    style={{ fontFamily: 'Inter, sans-serif' }}
                                >
                                    {formatDate(deal.createdAt)}
                                </div>
                                <div
                                    className="flex-1 px-3 text-sm font-medium text-gray-900 truncate"
                                    style={{ fontFamily: 'Inter, sans-serif' }}
                                >
                                    {deal.title ?? '—'}
                                </div>
                                        ...
                                        <>
                                            <Avatar className="w-7 h-7 shrink-0">
                                                <AvatarFallback className="bg-indigo-100 text-indigo-700 text-[10px] font-semibold">
                                                    {getInitials(
                                                        deal.assignedBy.firstName,
                                                        deal.assignedBy.lastName,
                                                    )}
                                                </AvatarFallback>
                                            </Avatar>
                                            <span
                                ...
                                <div
                                    className="w-[200px] px-3 text-sm text-gray-500 truncate"
                                    style={{ fontFamily: 'Inter, sans-serif' }}
                                >
                                ...
                                <div
                                    className="w-[140px] px-3 text-sm font-semibold text-gray-900 text-right"
                                    style={{ fontFamily: 'Inter, sans-serif' }}
                                >
                ...
                <div className="flex items-center justify-between px-5 py-4">
                    <span
                        ...
                        style={{ fontFamily: 'Inter, sans-serif' }}
                    >
                        Показано {Math.min((page - 1) * PAGE_SIZE + 1, deals.length)}–
                        {Math.min(page * PAGE_SIZE, deals.length)} из {deals.length}
                    </span>
