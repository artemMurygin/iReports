 ...
 * `id`/`name`/`pathName`/`children`, see `contracts/commands/catalog.ts`) for `CategoryCombobox.tsx`
 ...
 * id, and by `SalaryRulesRuleRow`/`ruleSummary.ts` to show a category name in the collapsed row. */
