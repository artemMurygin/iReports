...
/**
 * Денежное поле карточки правила: `Ставка, ₽ / час` (`PayPerHour`) и `Сумма, ₽` (награда `Fixed`) —
 * одна и та же разметка с одинаковой фильтрацией ввода (`[^0-9.,]`), отличаются только подпись и
 * плейсхолдер.
 */
