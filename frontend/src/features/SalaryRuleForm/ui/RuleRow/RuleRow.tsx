 ...
 * draft always renders as `core/ui/RuleFormCard` instead — see `../RuleList/ui/RuleListItems.tsx`).
 *
 ...
 * Инженер"`) and delete only reappears once the row is expanded into `core/ui/RuleFormCard`
 ...
 */
export function RuleRow({ draft, index, categories = [], onExpand, onDelete, className }: RuleRowProps) {
