...
export function SeriesCard({ series, mode, color }: Props) {
    ...
    // вырожденный график без видимой линии — просто одинокая точка на пустом фоне. Вместо линии
    // `dot` ниже рисует явный кружок только на `lastIndex` (единственной точке в этом случае).
