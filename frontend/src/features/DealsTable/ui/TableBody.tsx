...
export function TableBody({ paginated, renderRow }: TableBodyProps) {
    if (paginated.length === 0) {
        return <div className="flex items-center justify-center h-16 text-sm text-gray-400">Нет данных</div>
    }
