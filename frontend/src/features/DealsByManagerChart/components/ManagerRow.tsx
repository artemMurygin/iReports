import type { ManagerStatItem } from '../hooks/useManagerStats'
...
export function ManagerRow({ item }: Props) {
    const { name, totalCount, wonCount, revenue, conversion, color } = item

    return (
        <div className="flex items-center gap-3">
            <span className="text-s text-gray-700 shrink-0 truncate" style={{ width: 130, fontFamily: 'Inter, sans-serif' }}>
                {name}
            </span>
