...
import { ShopSalesPlanRepositoryPort } from '@/domains/shop/modules/sales/application/ports/shop-sales-plan.port';
import {
    ShopSalesPlanMapper,
    categoryToPersistence,
} from '../mappers/shop-sales-plan.mapper';
    ...
    async update(entity: ShopSalesPlan): Promise<void> {
        ...
        await this.write(entity, (client) =>
            client.salesPlan.update({
                ...
                // shop (shop-accounting-cache-freshness.ts).
                data: {
