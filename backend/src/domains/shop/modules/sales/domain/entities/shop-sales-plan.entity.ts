...
import { ShopSalesPlanApproval } from '../value-objects/shop-sales-plan-approval.value-object';
import {
    ...
    SalesPlanSource,
    SalesPlanStatus,
} from '../types/shop-sales-plan.types';
...
// infrastructure/mappers/shop-sales-plan.mapper.ts), тот же приём, что уже
