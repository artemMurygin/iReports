...
import type { ShopSalesPerformanceByCategory } from '@/domains/shop/modules/accounting/domain/types/shop-calculation-context.types';
...
// (см. shop-calculation-context.types.ts).
//
