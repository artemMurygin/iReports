...
import { ShopPeriodAlreadyClosedException } from '@/domains/shop/modules/accounting/domain/exceptions/accounting-period.exception';
...
import { RecalculateShopAccountingPeriodCommand } from './recalculate-accounting-period.command';
