...
import { CreateShopMotivationSchemaHandler } from './create-motivation-schema.handler';
import { CreateShopMotivationSchemaCommand } from './create-motivation-schema.command';
