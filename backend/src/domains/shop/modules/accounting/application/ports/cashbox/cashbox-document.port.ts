...
// забинжена в SHOP_ERP_CASH_DOCUMENT_PORT в accounting.module.ts. См.
...
export interface ErpCashDocumentPort {
    ...
    // Реализация делегирует в SHOP_PAYOUT_CASHBOX_RECORD_REPOSITORY (см.
    // application/ports/erp-cash/payout-cashbox-record-repository.port.ts —
    // собственный независимый класс shop с Фазы 4
    // docs/service-shop-boundary-violations-fix, до этой фазы делегировала
    // в PAYOUT_CASHBOX_RECORD_REPOSITORY domains/service) — этот метод
