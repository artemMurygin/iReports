...
// раз при старте процесса, читаются ShopCashboxConfigRepository
// (domains/shop/modules/accounting/infrastructure/repositories/cashbox/cashbox-config.repository.ts
...
// application/ports/erp-cash-config.port.ts) через
