...
import { ShopTaskCompletionRepositoryPort } from '@/domains/shop/modules/accounting/application/ports/shop-task-completion.port';
import { ShopTaskCompletionMapper } from '../mappers/shop-task-completion.mapper';
