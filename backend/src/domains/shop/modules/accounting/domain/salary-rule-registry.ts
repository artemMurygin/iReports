...
import { TaskCompletedShopEntity } from '@/domains/shop/modules/accounting/domain/entities/salary-rules/task-completed.entity';
import {
    ShopSalaryRuleClass,
    ShopSalaryRuleTypes,
...
// направлений есть совпадающие по названию типы ('PayPerHour',
// 'TaskCompleted'): это две РАЗНЫЕ Map, в разных модулях, никогда не
// смешиваются в рантайме — см. комментарий у SalaryRule.direction в
// prisma/schema/salary.prisma, где объясняется, как две этих Map не
// путаются на уровне персистентности.
...
>([
    ...
    ['TaskCompleted', TaskCompletedShopEntity],
]);
