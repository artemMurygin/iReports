...
// Собственный реестр типов правил магазина (Фаза 12, issue #57) —
...
// направлений есть совпадающий по названию тип 'PayPerHour': это две
...
//
// Фаза 13 (issue #64) добавит сюда 'UsedProductSold' и 'TaskCompleted' —
// расширение Map, без изменения уже зарегистрированных записей.
