...
import { ShopPeriodClosure } from '../../value-objects/period-closure.value-object';
import {
    ShopPeriodAlreadyClosedException,
    ShopPeriodNotClosedException,
} from '../../exceptions/accounting-period.exception';
import { ShopAccountingPeriodClosedDomainEvent } from '../../events/accounting-period-closed.domain-event';
...
// accounting_periods, см. accounting-period.mapper.ts), тот же приём,
