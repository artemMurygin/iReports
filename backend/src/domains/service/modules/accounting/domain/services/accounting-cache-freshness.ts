...
// docs/payroll/plan-payroll-calculation.md), описанного в PRD как ключ
...
// сворачиваются в одну строку сравнения (см. buildStamp), вычисляемую заново
// при каждом чтении отчёта:
//
