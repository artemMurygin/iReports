...
export type PayoutCashboxRecordProps = {
...
export type CreatePayoutCashboxRecordProps = PayoutCashboxRecordProps;
...
// create/delete-payout.handler.ts, §2.2
// docs/service-shop-boundary-violations.md); с этой фазы у shop собственная
// независимая сущность Cashbox
// (domains/shop/modules/accounting/domain/entities/cashbox/payout-cashbox-record.entity.ts,
...
export class Cashbox extends AggregateRoot<PayoutCashboxRecordProps> {
    ...
    static createPayout(create: CreatePayoutCashboxRecordProps): Cashbox {
        return new Cashbox({
            id: randomUUID(),
            props: { ...create },
        });
