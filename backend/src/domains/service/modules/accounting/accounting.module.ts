...
import { GetAccountingPeriodHttpController } from '@/domains/service/modules/accounting/interface/http-controllers/accounting-period/get-accounting-period.http.controller';
import { ListSalaryRuleTypesHttpController } from '@/domains/service/modules/accounting/interface/http-controllers/motivation-schema/list-salary-rule-types.http.controller';
import { ListSalaryAccrualsHttpController } from '@/domains/service/modules/accounting/interface/http-controllers/salary-accrual/list-salary-accruals.http.controller';
import { GetSalaryAccrualHttpController } from '@/domains/service/modules/accounting/interface/http-controllers/salary-accrual/get-salary-accrual.http.controller';
...
@Module({
    ...
    imports: [
        ...
        // replace-bitrix-task-integration, design.md решение 1/5 — сквозной
        // модуль src/modules/tasks: TASK_REPOSITORY (для
        // task-completion-statuses.builder.ts/BuildServiceCalculationContextService,
        // напрямую, без Port/Adapter) и CancelTaskForRuleDeletionService
        // (для UpdateMotivationSchemaHandler); CreateTaskCommand
