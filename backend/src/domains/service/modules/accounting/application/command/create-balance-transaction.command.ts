...
// аванс, премия, больничный, отпускные, штраф, корректировка. Generic по
// direction — хендлер один, контроллеры обоих доменов подставляют своё
// направление. amount — абсолютная величина для типов со знаком по типу,
// со знаком — для ADJUSTMENT (знак задаётся явно); подстановка знака — в
