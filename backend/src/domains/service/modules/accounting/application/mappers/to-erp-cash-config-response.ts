...
// entity === null — направление не поддерживается (защитный случай, сейчас
// ErpCashConfigProvider всегда возвращает сущность для service/shop) — тот
// же приём, что toAccountingPeriodResponse: пустой ответ со всеми полями
// null вместо 404. updatedAt всегда null (правка пользователя от
